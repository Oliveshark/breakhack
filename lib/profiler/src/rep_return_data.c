...
static ReturnData inline_create_data(void)
{
    return (ReturnData) {
        .fnum = 1.2,
        .count = 100,
...
static ReturnData variable_create_data(void)
{
    ReturnData data;
    data.fnum = 1.2;
    data.count = 100;
...
static void test_inline_static_data(RepetitionTester *tester)
{
...
static void test_variable_static_data(RepetitionTester *tester)
{
    while (rept_is_testing(tester)) {
        rept_begin(tester);
