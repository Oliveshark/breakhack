...
Sprite *
sprite_util_create_text_sprite(const char *fontPath, int size, SDL_Color fg,
                               SDL_Color outline, const char *fmt, ...)
{
	va_list args;
	...
	texture_load_from_text(sprite->textures[0], priceLabel, fg, outline,
	                       utilData.renderer);
